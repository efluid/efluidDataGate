...
public enum ErrorType {
    ...
    COMMIT_COMPARE_FAILED,
    COMMIT_COMPARE_NOT_READY,
    ...
    VERSION_LOCAL_MISSING,
    OUTPUT_ERROR,

    TRANSFORMER_CONFIG_WRONG,
    TRANSFORMER_NOT_FOUND,
    TRANSFORMER_EFUID_NO_REGION_SOURCE,
    TRANSFORMER_EFUID_NO_SITE,
    TRANSFORMER_EFUID_WRONG_REGION_DATA,
