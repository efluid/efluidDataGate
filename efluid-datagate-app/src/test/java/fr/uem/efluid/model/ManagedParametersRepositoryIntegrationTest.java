...
public class ManagedParametersRepositoryIntegrationTest {
    ...
    public void testExtractCurrentContentLow() {
        setupDatabase("diff7");
        try (Extraction extraction = this.extracted.extractCurrentContent(this.dictionary.getOne(this.dictionaryEntryUuid), new HashMap<>(), new Project(this.projectUuid))) {
