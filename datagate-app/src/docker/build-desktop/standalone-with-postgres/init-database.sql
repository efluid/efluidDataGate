...
ALTER TABLE "TCATEGORYMATERIEL" OWNER to "docker";
...
TABLESPACE pg_default;
ALTER TABLE "TTYPEMATERIEL" OWNER to "docker";
...
TABLESPACE pg_default;
ALTER TABLE "TTABLEOTHER" OWNER to "docker";
...
TABLESPACE pg_default;
ALTER TABLE "TTABLEOTHERTEST2" OWNER to "docker";
...
TABLESPACE pg_default;
ALTER TABLE "TMODELE" OWNER to "docker";
...
TABLESPACE pg_default;
ALTER TABLE "NOT_USED" OWNER to "docker";
