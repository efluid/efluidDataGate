...
Insert into "flyway_schema_history" ("installed_rank","version","description","type","script","checksum","installed_by","installed_on","execution_time","success") values ('2','1','init database','SQL','V1__init_database.sql','-1909929880',(select sys_context( 'userenv', 'current_schema' ) from dual),to_timestamp('14/04/20 15:50:05,920745000','DD/MM/RR HH24:MI:SSXFF'),'1039','1');
